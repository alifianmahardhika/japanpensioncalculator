export const translations = {
  en: {
    header: {
      ...
      subtitle: 'Lump-sum Withdrawal & Old-age Pension estimator for departing foreigners',
    },
    step1: {
    ...
    step2: {
      ...
      fullExemptDesc: 'Fully exempted — counts for 120-month threshold only, not payout',
      studentDefermentDesc: '学生納付特例 — counts for 120-month threshold only, not payout',
      npEntered: 'NP months entered',
      weightedPaid: 'Weighted contribution-paid',
      of: 'of',
      total: 'total',
      mismatch: 'NP months entered ({a}) do not match total period ({t}). The difference may be Employees\' Pension months — enter those in Step 3.',
    },
    step3: {
    ...
    result: {
      ...
      lumpSumBlockedOldAge: 'You have 120+ qualifying months — you cannot claim the Lump-sum Withdrawal Payment. You are entitled to the Old-age Pension instead.',
      lumpSumBlockedMin: 'Lump-sum Withdrawal is not available (below 6-month minimum).',
      ...
      disclaimer1: 'Estimate only. Actual amounts determined by Japan Pension Service. Old-age figures use FY2024 Basic Pension reference and are subject to annual revision.',
    ...
    epBox: {
      ...
      formula1: 'Formula: Amount = Average Standard Remuneration (ASR) × Payment Rate',
      formula2: 'Payment Rate = Insurance Rate × ½ × Number',
      step1: 'Step 1 — Average Standard Remuneration (ASR)',
      step1Formula: 'ASR = (Total standard monthly pay + Total bonuses) ÷ Total insured months',
      ...
      taxNote: '20.42% is withheld at source on EP payments to non-residents. You may reclaim it by appointing a tax agent and filing a return before leaving Japan.',
      belowMin: 'EP months ({n}) below the 6-month minimum, or no salary entered.',
    },
    oaBox: {
      title: 'Old-age Pension (老齢年金) — Monthly from Age 65',
      approx: 'Estimate based on current months. Actual amount determined by Japan Pension Service at retirement, adjusted annually.',
      ...
      needMore: 'You have {cur} qualifying months. You need {need} more to reach the 120-month threshold. This estimate shows what you would receive at 120 months.',
    },
    footer: 'Unofficial estimation tool. Data from Japan Pension Service (March 2026). Always verify with',
    ...
    guide: {
      ...
      verifyTopDesc: 'Enter the grand total from the 年金資格記録情報 page on Myna Portal. This lets us confirm all your entries are correct before calculating.',
      whereToFind: "Not sure where to find this number? Open the Myna Portal guide below ↓",
      verifyMatch: 'Match ✓  Calculator total ({calc} mo) matches your Myna Portal record.',
      verifyProjection: 'Projection mode ↗  Your portal currently shows {portal} mo. The calculator is projecting {calc} mo — you need {diff} more months to reach this.',
      verifyMismatch: 'Mismatch  Calculator shows {calc} months but portal shows {portal} months. Check your Step 2 and Step 3 entries.',
    },
  },
  ...
  ja: {
    ...
    step2: {
      ...
      fullExemptDesc: '全額免除 — 受給資格期間のみカウント（支給額に反映されません）',
      studentDefermentDesc: '学生納付特例 — 受給資格期間のみカウント（支給額に反映されません）',
      npEntered: '入力した国民年金月数',
      weightedPaid: '加重保険料納付済月数',
      of: '/',
      total: '合計',
      mismatch: '入力した国民年金月数（{a}ヶ月）が合計期間（{t}ヶ月）と一致しません。差分は厚生年金の月数の可能性があります — ステップ3で入力してください。',
    },
    step3: {
      title: 'ステップ3 — 厚生年金',
    ...
    result: {
      ...
      lumpSumBlockedOldAge: '受給資格期間が120ヶ月以上あるため、脱退一時金は請求できません。将来、老齢年金を受け取ることができます。',
      ...
      totalGross: '合計（税引き前）',
      totalNet: '合計（手取り）',
      disclaimer1: 'これは試算です。実際の支給額は日本年金機構が決定します。老齢年金額は2024年度の老齢基礎年金額を基準としており、毎年改定されます。',
    ...
    epBox: {
      ...
      step1: 'ステップ1 — 平均標準報酬額',
      step1Formula: '平均標準報酬額 ＝（全月の標準報酬月額 ＋ 標準賞与額の合計）÷ 全被保険者期間月数',
      ...
      tax: '源泉徴収税（20.42%）',
      net: '手取り支給額',
      taxNote: '非居住者への厚生年金脱退一時金の支給には20.42%の源泉徴収が行われます。出国前に納税管理人を選任し確定申告を行うことで還付を受けられる場合があります。',
      belowMin: '厚生年金月数（{n}ヶ月）が最低6ヶ月を下回っているか、給与が未入力です。',
    },
    oaBox: {
      title: '老齢年金 — 65歳から月額',
      approx: '現在の加入月数に基づく試算です。実際の支給額は退職時に日本年金機構が決定し、毎年改定されます。',
      basicTitle: '老齢基礎年金',
      ...
      epTitle: '老齢厚生年金',
      epFormula: '年額 ＝ 平均標準報酬額 × 5.481‰ × 厚生年金月数（2003年4月以降の率）',
      asr: '平均標準報酬額',
      epMonths: '厚生年金月数',
      annualEP: '老齢厚生年金の年額',
      monthlyEP: '老齢厚生年金の月額',
      ...
      totalAnnual: '合計年額',
      needMore: '現在の受給資格期間は{cur}ヶ月です。老齢年金を受給するにはあと{need}ヶ月が必要です。この試算は120ヶ月到達時の予想額です。',
    },
    footer: '非公式試算ツール。日本年金機構（2026年3月）のデータに基づいています。必ず確認を',
    ...
    guide: {
      ...
      verifyTopDesc: 'マイナポータルの「年金資格記録情報」ページに表示される合計月数を入力してください。入力内容が正しいか確認できます。',
      whereToFind: 'この数字がどこにあるか分からない場合は、下のマイナポータルガイドを開いてください ↓',
      verifyMatch: '一致 ✓  計算結果（{calc}ヶ月）はマイナポータルの記録と一致しています。',
      verifyProjection: '予測モード ↗  ポータルの現在の記録は{portal}ヶ月です。計算機の予測は{calc}ヶ月 — あと{diff}ヶ月で到達します。',
      verifyMismatch: '不一致  計算結果は{calc}ヶ月ですが、ポータルは{portal}ヶ月を示しています。ステップ2・3の入力を確認してください。',
    },
  },
  ...
  id: {
    header: {
      ...
      subtitle: 'Estimasi Pembayaran Sekaligus & Pensiun Hari Tua bagi WNA yang meninggalkan Jepang',
    },
    step1: {
    ...
    step2: {
      ...
      fullExemptDesc: 'Bebas penuh — hanya untuk syarat 120 bulan, bukan pembayaran',
      studentDefermentDesc: '学生納付特例 — hanya untuk syarat 120 bulan, bukan pembayaran',
      npEntered: 'Bulan NP yang dimasukkan',
      weightedPaid: 'Iuran berbobot berbayar',
      of: 'dari',
      total: 'total',
      mismatch: 'Bulan NP ({a}) tidak cocok dengan total periode ({t}). Selisihnya mungkin bulan Pensiun Karyawan — masukkan di Langkah 3.',
    },
    step3: {
    ...
    result: {
      ...
      lumpSumBlockedOldAge: 'Anda memiliki 120+ bulan kualifikasi — tidak dapat mengklaim Pembayaran Sekaligus. Anda berhak atas Pensiun Hari Tua.',
      lumpSumBlockedMin: 'Pembayaran Sekaligus tidak tersedia (di bawah minimum 6 bulan).',
      ...
      disclaimer1: 'Ini hanyalah estimasi. Jumlah aktual ditentukan Japan Pension Service. Angka Pensiun Hari Tua menggunakan referensi FY2024 dan dapat berubah setiap tahun.',
    ...
    epBox: {
      ...
      formula1: 'Rumus: Jumlah = Rata-rata Remunerasi Standar (RRS) × Tingkat Pembayaran',
      formula2: 'Tingkat Pembayaran = Tingkat Asuransi × ½ × Angka',
      step1: 'Langkah 1 — Rata-rata Remunerasi Standar (RRS)',
      step1Formula: 'RRS = (Total gaji bulanan standar + Total bonus standar) ÷ Total bulan',
      ...
      taxNote: '20,42% dipotong di sumber untuk pembayaran EP kepada non-residen. Anda dapat mengklaim kembali dengan menunjuk agen pajak sebelum meninggalkan Jepang.',
      belowMin: 'Bulan EP ({n}) di bawah minimum 6 bulan, atau gaji belum dimasukkan.',
    },
    oaBox: {
      title: 'Pensiun Hari Tua (老齢年金) — Bulanan mulai Usia 65',
      approx: 'Estimasi berdasarkan bulan kontribusi saat ini. Jumlah aktual ditentukan Japan Pension Service saat pensiun, disesuaikan setiap tahun.',
      ...
      needMore: 'Anda memiliki {cur} bulan kualifikasi. Butuh {need} bulan lagi untuk mencapai 120 bulan. Estimasi ini menunjukkan jumlah jika Anda mencapai 120 bulan.',
    },
    footer: 'Alat estimasi tidak resmi. Data dari Japan Pension Service (Maret 2026). Selalu verifikasi di',
    ...
    guide: {
      ...
      verifyTopDesc: 'Masukkan total dari halaman 年金資格記録情報 di Myna Portal untuk memastikan semua data sudah diisi dengan benar.',
      whereToFind: 'Tidak tahu cara menemukannya? Buka panduan Myna Portal di bawah ↓',
      verifyMatch: 'Cocok ✓  Total kalkulator ({calc} bulan) sesuai dengan data Myna Portal Anda.',
      verifyProjection: 'Mode proyeksi ↗  Portal Anda saat ini menunjukkan {portal} bulan. Kalkulator memproyeksikan {calc} bulan — butuh {diff} bulan lagi untuk mencapainya.',
      verifyMismatch: 'Tidak cocok  Kalkulator menunjukkan {calc} bulan tetapi portal menunjukkan {portal} bulan. Periksa entri Langkah 2 dan Langkah 3.',
    },
  },
};
